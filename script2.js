var jsonStr = [
   ...
   function getFilterDirectorJson(){
       ...
       for(var i=0; i<filterObjs.length; i++){
           ...
           text+='<div>Reigon : '+filterObjs[0].director+'</div></div><div class="clear"></div>';
           text+='<div>In' +filterObjs[0].name+'There is' +filterObjs[0].rating+ 'people facing statutory Homelessness'
